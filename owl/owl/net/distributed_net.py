...
class ComputeUnitD(object):
    ...
    def histogram(self,n):
        if(self.out):
            print "=====",self.name,"====="
            print self.out.histogram(n).to_numpy()
...
class WeightedComputeUnit(ComputeUnitSimple):
    ...
    def histogram(self,n):
        if self.out or self.weight or self.weightdelta or self.weightgrad:
            print "=====",self.name,"====="
        if self.out:
            print "Output:"
            print self.out.histogram(n).to_numpy()
        if self.weight:
            print "Weights:"
            print self.weight.histogram(n).to_numpy()
        if self.weightgrad:
            print "Gradient:"
            print self.weightgrad.histogram(n).to_numpy()
        if self.weightdelta:
            print "Deltas:"
            print self.weightdelta.histogram(n).to_numpy()
...
class Net:
    ...
    def histogram(self,n):
        for u in self._toporder('TRAIN'):
            self.units[u].histogram(n)
